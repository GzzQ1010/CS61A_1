def berry_finder(t):
    ...
    #     return False
    # else:
    #     # a=[berry_finder(b) for b in branches(t)]
    #     # print(a)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    pin_city=make_city('pin_city',lat,lon)
    distance1=distance(pin_city,city_a)
    distance2=distance(pin_city,city_b)
    distance_map={get_name(city_a):distance1,get_name(city_b):distance2}
...
def dejavu(t, n):
    ...
    """False code, this only consider partial path """
    # if n-label(t)==0:
    #     print('Debug n-labe(t)',n-label(t))
    #     return True
    # for b in branches(t):
    #     print('Debug b=',b)
    #     print('Debug n-label(t)=',n-label(t))
    #     if dejavu(b,n-label(t)):
    #         return True
    # return False
